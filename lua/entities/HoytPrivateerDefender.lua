...
scripted_ents.Register( ENT, "HoytPrivateerDefender" )

list.Set( "NPC", "HoytPrivateerDefender", {
	Name = "#HoytPrivateerDefender",
	Class = "HoytPrivateerDefender",
...
sound.Add {
	...
	pitch = 100,
	sound = {
		"HoytPrivateer/Defender/ThoughtYouCouldHide.wav",
